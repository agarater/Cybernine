<template>
  <div class="inventario-container">
    ...
    <div class="product-grid">
      <div v-for="producto in filteredProducts" :key="producto.id" class="product-card">
        ...
        <div class="card-footer">
          ...
          <button @click="openAdjustModal(producto)" class="adjust-button">Ajustar Stock</button>
        </div>
    ...
    <AdjustStockModal
      :isVisible="showAdjustModal"
      :product="selectedProductToAdjust"
      @close="closeAdjustModal"
      @confirm-adjust="handleStockAdjustmentConfirmed"
    />
...
// --- MANEJO DEL INPUT DE PRECIO (SIN CAMBIOS) ---
...
// --- FUNCIÓN DE VALIDACIÓN DE CAMPOS (SIN CAMBIOS) ---
...
// --- FUNCIÓN PARA CANCELAR REGISTRO (SIN CAMBIOS) ---
...
// --- Computed Property para previsualizar el stock resultante (SIN CAMBIOS) ---
...
// --- FUNCIÓN PARA REGISTRAR MOVIMIENTO (PRODUCTO EXISTENTE) (SIN CAMBIOS) ---
...
/* --- NUEVOS ESTILOS PARA EL FORMULARIO DE PRODUCTO NUEVO (SIN CAMBIOS) --- */
...
/* --- ESTILOS PARA "PRODUCTO ENCONTRADO" (SIN CAMBIOS) --- */
...
/* INPUT DE PRECIO CON ADVERTENCIA (SIN CAMBIOS) */
.price-input-wrapper {
  position: relative;
  display: flex;
  align-items: center;
